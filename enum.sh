...
git commit -m "Added antlr-url-grammar"
...
git remote set-url origin https://github.com/enamulhaque028/antlr-url-grammar.git
############
# Step: 07 #
############
...
git push --all -f https://github.com/enamulhaque028/antlr-url-grammar.git
